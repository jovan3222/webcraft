...
import Image from '../o-nama/o-nama-image.jpg';
import ContactImage from '../../Main/home-kontakt.jpg';

const content = [
    {
        title: 'Kontaktirajte nas',
        text: 'Slobodno nas kontaktirajte ukoliko ste zainteresovani da radite sa nama, ili da jednostavno razgovarate o vašim idejama. Možete se bez ustručavanja savjetovati kod nas kako bi smo vam pomogli da pretvorite vaše ideje u stvarnost.'
    },
    {
        title: 'Kontakt'
    },
    ...
    <main className='o-nama-main'>
        ...
        <section className='o-nama-content-section'>
            <div className='o-nama-content-container'>
                ...
                <div className='decor-line' id="decor-line"></div>
                <div className='onama-decor-title-div' id="kontakt-decor-title-div"></div>
                <div className='onama-decor-title-div2' id="kontakt-decor-title-div2"></div>
                <p>{content[0].text}</p>
                <div className='onama-decor-text-div' id="kontakt-decor-text-div"></div>
                <div className='onama-decor-text-div2' id="kontakt-decor-text-div2"></div>
            </div>
            <div className='o-nama-image-container' id="o-nama-image-container">
